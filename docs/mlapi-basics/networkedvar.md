...
:::warning
Disclaimer: The NetworkedVar, NetworkedList and NetworkedDictionary implementations are **primarily** designed as samples showing how to create INetworkedVar structures. The NetworkedVar container is however considered production ready for simple types.
:::
