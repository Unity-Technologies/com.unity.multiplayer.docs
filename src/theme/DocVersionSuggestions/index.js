...
function UnreleasedVersionLabel({siteTitle, versionLabel}) {
  return (
    <Translate
      ...
      {
        'This is in-development documentation for {siteTitle} {versionLabel} version.'
      }
    </Translate>
  );
}
...
function UnmaintainedVersionLabel({siteTitle, versionLabel}) {
  return (
    <Translate
      ...
      {
        'This is documentation for {siteTitle} {versionLabel}, which may be a previous or preview version.'
      }
    </Translate>
  );
}
