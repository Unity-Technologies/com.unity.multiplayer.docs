...
function ShareButton() {
  return (
    <div className="dropdown dropdown--hoverable pointer">
      <a target="_blank" rel="noreferrer noopener" style={{ marginTop: '0.45rem' }}>
        <FontAwesomeIcon icon={faShareSquare} style={{ fontSize: "16px"}}/>
        <>&nbsp;</>
      </a>
      <button className="button button--lg button--link padding-horiz--none pointer" style={{ fontWeight: 400, fontFamily: "inherit", fontSize: "inherit"}}>Share</button>
      <ul className="dropdown__menu">
        ...
        <li>
          <a className="dropdown__link icons" href="#url">
            <FontAwesomeIcon icon={faFacebookSquare} className="margin-right--sm"/>
            Facebook
          </a>
        </li>
        <li>
