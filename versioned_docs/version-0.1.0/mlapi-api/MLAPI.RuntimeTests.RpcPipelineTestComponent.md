...
How many times will we iterate through the various NetworkUpdateStage
...
Determine if we have iterated over more than our maximum stages we want
to test
...
| Type           | Description                                              |
|----------------|----------------------------------------------------------|
| System.Boolean | true or false (did we exceed the max iterations or not?) |

### IsTestComplete()

<div class="markdown level1 summary">

Returns back whether the test has completed the total number of
iterations
