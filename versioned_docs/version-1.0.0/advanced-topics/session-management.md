...
```csharp reference
https://github.com/Unity-Technologies/com.unity.multiplayer.samples.coop/blob/v1.3.1-pre/Packages/com.unity.multiplayer.samples.coop/Utilities/Net/SessionManager.cs
```
