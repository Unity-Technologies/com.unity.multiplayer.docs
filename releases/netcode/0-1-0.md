...
* GitHub 460: Fixed an issue for RPC where the host-server wasn't receiving RPCs from the host-client and vice versa without the loopback flag set in `NetworkingManager`.  <!-- MTT466 -->
